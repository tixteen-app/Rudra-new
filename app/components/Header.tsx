...
//   const navItems = ['Solutions', 'Industries', 'Advantages', 'About', 'Knowledge Hub', 'Contact'];
...
//             </div>
//             <span className="text-lg text-gray-800 font-normal">Texmo Blank</span>
//           </motion.div>
...
//                 className="text-gray-600 hover:text-gray-900 transition-colors text-sm font-normal"
...
//             <Search size={18} className="text-gray-600 cursor-pointer hover:text-gray-900 transition-colors" />
//             <span className="text-sm text-gray-600 font-normal">EN</span>
//             <motion.button
//               className="bg-gray-800 text-white px-5 py-2.5 rounded-md text-sm font-normal hover:bg-gray-700 transition-colors flex items-center space-x-2"
//               whileHover={{ scale: 1.02 }}
//               whileTap={{ scale: 0.98 }}
//             >
...
//                 key={item}
//                 href={`#${item.toLowerCase().replace(' ', '-')}`}
//                 className="block py-3 text-gray-700 hover:text-gray-900 transition-colors text-sm"
...
//               <button className="bg-gray-800 text-white px-5 py-2.5 rounded-md text-sm w-full flex items-center justify-center space-x-2">
//                 <span>Get started</span>
//                 <ArrowRight size={14} />
//               </button>
//             </div>
